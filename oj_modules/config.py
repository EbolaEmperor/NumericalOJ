...
_CODE_DEFAULTS: dict[str, str] = {
    ...
    "WEB_GUNICORN_THREADS": "256",
    "WEB_GUNICORN_CONNECTIONS": "1024",
    "WEB_GUNICORN_BACKLOG": "512",
    "WEB_SSE_MAX_CONNECTIONS": "192",
    "MYSQL_CONNECT_TIMEOUT": "5",
    "MYSQL_POOL_MIN_SIZE": "2",
    "MYSQL_POOL_MAX_SIZE": "6",
    "MYSQL_POOL_WAIT_TIMEOUT": "3",
    "MYSQL_POOL_RECYCLE_SECONDS": "1200",
    "MYSQL_POOL_HEALTH_CHECK_INTERVAL_SECONDS": "30",
    "MYSQL_WEB_POOL_MAX_SIZE": "24",
    "MYSQL_WEB_POOL_WAIT_TIMEOUT_SECONDS": "0.05",
    ...
    "LEAN4_JUDGE_MEM_LIMIT": '"4g"',
    "LEAN4_INTERACTIVE_MEM_LIMIT": '"4g"',
    "LEAN4_INTERACTIVE_CPU_LIMIT": '"2"',
    "LEAN4_INTERACTIVE_PIDS_LIMIT": "128",
    "LEAN4_INTERACTIVE_MAX_SESSIONS": "8",
    "LEAN4_INTERACTIVE_IDLE_SECONDS": "600",
    "LEAN4_INTERACTIVE_TIMEOUT_SECONDS": "180",
    "OJ_ROOT_PATH": '""',
    "JUDGER_RUN_ROOT": '""',
...
STATIC_CACHE_MAX_AGE_SECONDS = _env_int("STATIC_CACHE_MAX_AGE_SECONDS")
...
WEB_GUNICORN_THREADS = _env_int("WEB_GUNICORN_THREADS")
WEB_GUNICORN_CONNECTIONS = _env_int("WEB_GUNICORN_CONNECTIONS")
WEB_GUNICORN_BACKLOG = _env_int("WEB_GUNICORN_BACKLOG")
WEB_SSE_MAX_CONNECTIONS = _env_int("WEB_SSE_MAX_CONNECTIONS")
...
MYSQL_POOL_HEALTH_CHECK_INTERVAL_SECONDS = _env_float(
    "MYSQL_POOL_HEALTH_CHECK_INTERVAL_SECONDS"
)
MYSQL_WEB_POOL_MAX_SIZE = _env_int("MYSQL_WEB_POOL_MAX_SIZE")
MYSQL_WEB_POOL_WAIT_TIMEOUT_SECONDS = _env_float(
...
LEAN4_JUDGE_MEM_LIMIT = _env_str("LEAN4_JUDGE_MEM_LIMIT")
