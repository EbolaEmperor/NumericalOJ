...
_CODE_DEFAULTS: dict[str, str] = {
    ...
    "VIBEHUB_BUILD_SLOT_TIMEOUT_SECONDS": "5",
    "VIBEHUB_PROXY_SLOT_TIMEOUT_SECONDS": "0.25",
    "VIBEHUB_HEALTH_PROBE_SLOT_TIMEOUT_SECONDS": "0.1",
...
VIBEHUB_BUILD_CACHE_MAX_BYTES = _env_int(
