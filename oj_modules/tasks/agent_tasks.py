...
from oj_modules.tasks.agent_solve_task import register_agent_solve_problem_task
from oj_modules.tasks.agent_generate_testdata_task import register_agent_generate_testdata_task
