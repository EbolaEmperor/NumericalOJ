...
from oj_modules.identicon_utils import text_identicon_presentation
...
def get_db_connection():
    """惰性取得项目统一连接，避免 ``db_services`` 集成命名空间规则时循环导入。"""
    from oj_modules.db_services import get_db_connection as connection_factory
...
def run_identity_namespace_transaction(operation: Callable[[object], _T]) -> _T:
