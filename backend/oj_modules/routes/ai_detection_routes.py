...
from backend.oj_modules.ai_detection.presentation import decode_detection_result_details
...
def delete_task(task_id):
    ...
    from backend.oj_modules.ai_detection.task_tracker import _load
    data = _load(task_id)
...
def stop_task(task_id):
    ...
    import time
    from backend.oj_modules.ai_detection.task_tracker import _load, _save
