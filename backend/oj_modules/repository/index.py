...
from backend.oj_modules.ai.endpoints import create_embeddings
from backend.oj_modules.ai.parsing import _extract_first_json_object_relaxed
...
def _publish_repository_index_generation(
    *,
    ...
    from backend.oj_modules.repository.tree import repository_user_lock
