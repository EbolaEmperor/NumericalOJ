...
from backend.oj_modules.repository.storage import RepositoryPathError, validate_relative_path
...
def get_user_repository_files_by_names(user_id, filenames, submission_id=None):
    ...
    if submission_id is not None:
        ...
        from backend.oj_modules.repository.tree import list_repository_files
