...
def _save(task_id, data):
    ...
    try:
        from backend.oj_modules.db_services import upsert_ai_detection_task
...
def _load(task_id):
    ...
    # Fall back to MySQL
    try:
        from backend.oj_modules.db_services import get_ai_detection_tasks
...
def delete_task(task_id):
    ...
    if rds is not None:
        try:
            ...
            pass
    try:
        from backend.oj_modules.db_services import delete_ai_detection_task
