...
from backend.oj_modules.ranking.db import get_competition, get_ranking_submission
from backend.oj_modules.ranking.presentation import competition_scoring_mode
