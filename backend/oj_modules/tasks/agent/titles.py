...
from backend.oj_modules.ai.endpoints import call_text
...
def _initial_agent_session_message(session_id):
    ...
    try:
        from backend.oj_modules.agents.sessions import get_agent_session_turns
...
def generate_initial_agent_session_title(
    ...
    *,
    ...
    from backend.oj_modules.agents.sessions import claim_agent_session_title_generation
