...
from backend.oj_modules.tasks.rejudge_tasks import register_rejudge_task
from backend.oj_modules.tasks.promptly_tasks import register_promptly_generate_submission_task
from backend.oj_modules.tasks.agent.registry import (
...
from backend.oj_modules.tasks.ai_detection_tasks import register_ai_detection_tasks
from backend.oj_modules.tasks.class_activity_tasks import (
    register_class_activity_refresh_task,
    seed_class_activity_refresh,
)
from backend.oj_modules.tasks.ranking.evaluate import register_ranking_evaluate_task
from backend.oj_modules.tasks.ranking.elo import (
...
from backend.oj_modules.tasks.ranking.reverse_judge import (
...
from backend.oj_modules.tasks.ranking.batch_pull import (
    register_ranking_batch_tasks,
    init_batch_progress_cache,
    get_probe_job,
)
from backend.oj_modules.tasks.ranking.bulk_rejudge import (
