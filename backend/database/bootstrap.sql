...
CREATE TABLE `agent_sessions` (
  ...
  `judge_kind` varchar(32) DEFAULT NULL,
  ...
  KEY `idx_agent_judge_attempt` (`submission_id`,`attempt_id`,`judge_kind`),
  KEY `idx_agent_sessions_kind_updated` (`task_kind`,`updated_at`),
...
CREATE TABLE `ranking_agent_judge_endpoints` (
  ...
  `cached_input_price_per_million` decimal(20,8) NOT NULL DEFAULT '0',
