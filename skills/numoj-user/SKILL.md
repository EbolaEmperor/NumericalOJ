...
For Lean 4 proof-problem reading, local workspace initialization, verification, and submission workflows, read [references/lean4-problems.md](references/lean4-problems.md) before acting.
